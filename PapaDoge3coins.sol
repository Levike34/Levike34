...
contract DividendDistributor is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BUSD.balanceOf(address(this)); //Main
...
contract DividendDistributor2 is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = DAI.balanceOf(address(this)); //Main
...
contract DividendDistributor3 is IDividendDistributor {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = USDT.balanceOf(address(this)); //Main
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        try distributor.deposit{value: (amountBNBReflection / 100) * 60}() {} catch {}
        try distributor2.deposit{value: (amountBNBReflection / 100) * 30}() {} catch {}
        try distributor3.deposit{value: (amountBNBReflection / 100) * 10}() {} catch {} 
