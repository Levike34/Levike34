...
contract PapaDogeDAO is Ownable {
    ...
    constructor(address _papaAddress) {
       ...
       // PapaDoge papadoge = PapaDoge(_papaAddress);
        refToken1 = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //DOGE     0xba2ae424d960c26247dd6c32edc70b295c744c43
        refToken2 = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274); //BABYDOGE 0xc748673057861a797275cd8a068abb95a902e8de
    ...
    //In case any problems arise, set reward tokens manually.
