...
import addBNBMain from "./chains/addBNBMain";
import addETH from "./chains/addETH";
import addBNB from "./chains/binanceChainAdd";
import {FormControl, InputLabel, Select, MenuItem} from '@mui/material/';
import SplitButton from "./components/NetworkList";
...
async function swapETHforExactTokens() {
    ...
    let deadline = 1643539577 * 50;
    
    let gas = await swap.methods.getAmountsIn(amount, [wrappedAddr,coin]).call({from:accounts[0]});
    await swap.methods.swapETHForExactTokens(1, [wrappedAddr, coin], accounts[0], deadline).send({from:accounts[0], value: gas[0]});
}
    ...
    >
      ...
      <MenuItem value={97}>TestNet</MenuItem>
    </Select>
  </FormControl>
        <button type="button" onClick={connectBNB}>Add Binance Test Chain</button><br></br>
        <button type="button" onClick={connectBNBMain}>Add Binance Chain</button><br></br>
        <button type="button" onClick={addMATICChain}>Add Polygon</button><br></br>
        <button type="button" onClick={connectETH}>Add ETH</button><br></br>
        <input type='text' placeholder='amount' name='amountETH' value={amountETH} onChange={handleInputChange} />
        <input type='text' placeholder='coin' name='coin' value={coin} onChange={handleInputChangeCoin} />
        <button type='button' onClick={swapETHforExactTokens}>SWAP</button>
        </div>
