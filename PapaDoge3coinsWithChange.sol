...
contract DividendDistributor is IDividendDistributor {
    ...
    //IBEP20 refToken = IBEP20(refTokenAddress);  //DOGE
    //IBEP20 DAI = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274);  //BABYDOGE
    //IBEP20 USDT = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //FLOKI
    ...
    constructor (address _router, IBEP20 _refToken) {
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = refToken.balanceOf(address(this)); //Main

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(refToken);
        ...
        uint256 amount = refToken.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            refToken.transfer(shareholder, amount);
...
contract DividendDistributor2 is IDividendDistributor {
    ...
    //IBEP20 BUSD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);  //DOGE
    //IBEP20 refToken = IBEP20(_refTokenAddress);  //BABYDOGE
    //IBEP20 USDT = IBEP20(0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684); //FLOKI
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    IDEXRouter router;
...
contract DividendDistributor3 is IDividendDistributor {
    ...
    //IBEP20 BUSD = IBEP20(0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7);  //DOGE
    //IBEP20 DAI = IBEP20(0x8a9424745056Eb399FD19a0EC26A14316684e274);  //BABYDOGE
    //IBEP20 refToken = IBEP20(refTokenAddress); //FLOKI
    address WBNB = 0xae13d989daC2f0dEbFf460aC112a837C89BAa7cd;
    IDEXRouter router;
...
contract EverGrow is IBEP20, Auth {
    using SafeMath for uint256;
    address MAIN = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7;

    uint256 public constant MASK = type(uint128).max;
    address BUSD = 0x78867BbEeF44f2326bF8DDd1941a4439382EF2A7; //DOGE
    address DAI = 0x8a9424745056Eb399FD19a0EC26A14316684e274;  //BABYDOGE
    address USDT = 0x7ef95a0FEE0Dd31b22626fA2e10Ee6A223F8a684; //FLOKI
    ...
    uint256 public _maxTxAmount = _totalSupply.div(2); // 0.25%
    ...
    constructor (
        ...
        WBNB = router.WETH();
        distributor = new DividendDistributor(_dexRouter, token1);
        distributor2 = new DividendDistributor2(_dexRouter, token2);
        distributor3 = new DividendDistributor3(_dexRouter, token3);
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        //
        //@@@ Checks each distributor to see if they are able to send the distributions to holders.
        //
...
//        emit Transfer(sender, recipient, amount);
    ...
    function swapBack() internal swapping {
        ...
        //Each distributor's refToken is variable as well as the refPercent via voting.
        try distributor.deposit{value: (amountBNBReflection / 100) * refPercent1}() {} catch {}
        try distributor2.deposit{value: (amountBNBReflection / 100) * refPercent2}() {} catch {}
        try distributor3.deposit{value: (amountBNBReflection / 100) * refPercent3}() {} catch {}     
