    ...
    <div>
      {mainPage ? 
            ...
            <p></p>
               ...
               <img className='lockMobile' src='lock.png'/>
                   <button className='craftButton-mobile' type='button'> Play </button>
                   </div>
             
                 
                <button className='craftButton-mobile' type='button'><Link to='quests'  style={{color: 'cyan', textDecoration: 'none'}}> Quests</Link> </button>
        
                   <button className='craftButton-mobile' onClick={() => setMainPage(!mainPage)} >Marketplace </button>

                   <div className='rowMain'>
                   <img className='lockMobile' src='lock.png'/>
                   <button className='craftButton-mobile' type='button'><Link to='character'  style={{color: 'cyan', textDecoration: 'none'}}>Create Character</Link> </button>
                   </div>
            ...
            <div className="column">
              ...
              <button type='buttonpic' onClick={() => setMainPage(!mainPage)}>Home</button>
