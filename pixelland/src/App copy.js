...
if(!isMobile) {
  return(
    <div>
      ...
      <div className='Main'>
        ...
        <p></p>
             ...
             <div className='column'>
               ...
               <button className='craftButton3' onClick={() => alert("Make 1 chocolate donut.  Reward:  5000 PIXEL.")} type='button'> Quests </button>
             
              
               <button className='craftButton2' onClick={() => setMainPage(!mainPage)} >Marketplace </button>
      ...
      : 
      <CSSTransition in={mainPage}  classNames='Book' mountOnEnter  unmountOnExit >
            <div id='start'className='column'>
      <div className="HeaderBar">
        <div className="column">
      <img className='infoUi'src='character.png'></img>
      <button className='buttonpic buyButton' onClick={() => setMainPage(!mainPage)} type='button'>Home</button>
    </div>
    <div className='mask'>
      <div className='column'>
  ...
  return (
      <div className="column">
        ...
        <button type='buttonpic' onClick={update}>Connect</button>
